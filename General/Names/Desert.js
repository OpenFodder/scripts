...
PhaseName.Desert = {
    ...
    nameGen: function() {
        ...
        rnd = Map.getRandomFloat(0, 1) * this.nm1.length | 0;
        rnd2 = Map.getRandomFloat(0, 1) * this.nm2.length | 0;
        if(i < 5){
            name = "The " + this.nm1[rnd] + " " + this.nm2[rnd2];
        }else{
            name = this.nm1[rnd] + " " + this.nm2[rnd2];
        }
